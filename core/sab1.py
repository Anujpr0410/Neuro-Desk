...
class SAB1:
    ...
    def __init__(self, config: Dict = None, config_file: str = "config/config.json"):
        ...
        self.memory_manager = get_memory_manager("SAB1")
...
5. Pass your output clearly labeled for SAB2 to use as context."""
    ...
    async def _save_to_memory(self, task: str, output: str):
        """Save research results to SAB1's memory."""
        metadata = {
            "type": "research",
            "task": task,
            "agent": "SAB1"
    ...
    async def chat(self, message: str, history: List[Dict] = None, stream_callback: Callable = None) -> Dict[str, Any]:
        ...
        # Inject long-term memory: query ChromaDB for relevant past research
        memory_context = ""
        try:
            ...
            if relevant_docs:
                memory_context = "\n\n--- LONG-TERM MEMORY (from past research tasks) ---\n"
